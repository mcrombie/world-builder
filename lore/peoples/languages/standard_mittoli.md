...
# Standard Mittoli
### *Aelossmitten* — "the speech of the middle land"

Standard Mittoli is the prestige dialect of the Mittoli language family, based on the speech of the Caeras valley cities and used across most of Azhora for formal writing, commerce, governance, and scholarship. It is not the oldest form of Mittoli — that distinction belongs to the Taler dialect of the Pyros uplands, which preserves features that standard Mittoli lost centuries ago — but it is the most widely understood.

It sounds, to a first-time listener, like flowing water occasionally interrupted by stone. The vowels are rich and open, sentences have a forward lean to them, and the diphthong *ae* gives formal speech a rising quality that speakers of drier languages tend to describe as either musical or exhausting.

---

## The Cael Script

Mittoli is written in the Cael Script — named for the *cael* root (water, flow) and reflecting the tradition that the original script was developed by river-traders who needed to mark cargo. It is written left to right, uses a true alphabet (all vowels written), and has 28 characters: 18 consonants and 10 vowel characters (5 pure vowels, 2 diphthongs, and 3 positional variants).

The script is not reproduced here in its native form; this document uses the standard scholarly romanization. Conventions:

| Romanization | Pronunciation | Notes |
|---|---|---|
| *th* | /θ/ | As in *thin* |
| *zh* | /ʒ/ | As in *measure* |
| *ny* | /ɲ/ | As in Spanish *ñ* |
| *ae* | /aɪ̯/ | Rising diphthong, like *ay* moving toward *ee* |
| *oe* | /ɔɪ̯/ | Like *oy* but rounder |
| *rr* | /r/ | Trilled; single *r* is a flap |
| Double consonant | — | Held longer; gemination is meaningful |
...
|---|---|---|---|---|---|
| **Stop** | p b | t d | | k g | |
| **Fricative** | v | s z | zh /ʒ/ | | h |
| **Dental fric.** | | th /θ/ | | | |
| **Nasal** | m | n | ny /ɲ/ | | |
| **Lateral** | | l | | | |
| **Trill/Tap** | | r / rr | | | |

*zh* appears only before back vowels (a, o, u) and the diphthong *ae* in native words.
*ny* appears only before front vowels (e, i) in native words.
Gemination (double consonants) is phonemically significant: *nill* (stone) vs. *nil* (nothing, empty); *coss* (hard travel) vs. *cos* (a road).
...
*ae* is the signature sound of Mittoli — it appears in roughly one in six words and gives the language its characteristic rising quality. Northern dialects collapse it to a flat *a* or *e*, which is one of the first things that marks a northern speaker to a southerner's ear.

### Syllable Structure

(C)(C) V (C)(C) — consonant clusters are permitted but constrained:

Permitted onset clusters: *tr-, dr-, sm-, sn-, vr-, st-, str-, kl-, gl-, ny-* (before vowel)
Permitted coda clusters: *-lm, -rm, -nt, -nd, -ss, -th, -st, -sk*
Word-final vowels are common and give Standard Mittoli its open, flowing quality. Northern Mittoli systematically drops unstressed final vowels — "Mittolo" becomes "Mttol," "Gala" becomes "Gal."

### Stress

Penultimate (second-to-last syllable) in most words: **MÍT**-to-lo, **CÁE**-ras, **GÁ**-la.
Stress shifts to a syllable containing a geminate consonant or diphthong: a-**ZHÓR**-a, ca-**ÉL**-os.
Northern Mittoli: fixed initial stress on all words. This is the single biggest prosodic difference between north and south.
...
All Mittoli nouns belong to one of four classes, identifiable by their stem ending. Class membership is mostly predictable from meaning but has historical exceptions.

| Class | Name | Covers | Stem marker |
|---|---|---|---|
| I | *voran* | Living beings, persons, animals, spirits | -or-, -an- |
| II | *mithan* | Places, geography, structures | -ith, -ol, -a, -oss |
| III | *nethon* | Objects, materials, abstractions | -el, -on, -um, -am |
| IV | *aethos* | Nominalized actions, events, processes | -oe, -eth |

### Cases

Six cases, marked by suffix on the noun stem:

| Case | Suffix (Class I) | Suffix (Classes II–IV) | Function |
|---|---|---|---|
| **Nominative** | — | — | Subject of clause |
| **Accusative** | -om | -am | Direct object |
| **Genitive** | -ae | -ae | Possession; "of the —" |
| **Dative** | -in | -in | Indirect object; "to/for the —" |
| **Locative** | -el | -el | Position; "at/in the —" |
| **Directive** | -ath | -ath | Motion toward; "toward the —" |

Plural is formed by adding *-oss* before the case suffix for Class I, and *-en* before case suffix for Classes II–IV.

**Example — *voran* (person, Class I):**

| Case | Singular | Plural |
|---|---|---|
| Nominative | *voran* | *voranoss* |
| Accusative | *voranom* | *voranossam* |
| Genitive | *voranae* | *voranossae* |
| Dative | *voranin* | *voranossìn* |
| Locative | *voranel* | *voranossèl* |
| Directive | *voranath* | *voranossath* |

**Example — *homath* (house/dwelling, Class III):**

| Case | Singular | Plural |
|---|---|---|
| Nominative | *homath* | *homathen* |
| Accusative | *homatham* | *homathènam* |
| Genitive | *homathae* | *homathenae* |
| Dative | *homathin* | *homathènin* |
| Locative | *homathel* | *homathènel* |
| Directive | *homathath* | *homathènath* |

### Verbs

Mittoli verbs encode **aspect** rather than tense. Time is contextual (established by adverbs or shared knowledge); what is grammatically marked is whether an action is ongoing, completed, or intended.

**Three aspects:**

| Aspect | Prefix | Meaning |
|---|---|---|
| Imperfective | Ø (none) | Ongoing, habitual, general truth |
| Perfective | *ve-* | Completed, bounded action |
| Prospective | *ae-* | Intended, future, wished-for |

**Six person/number suffixes:**

| | Singular | Plural |
|---|---|---|
| **1st** | -om | -omm |
| **2nd** | -eth | -ethen |
| **3rd** | -os (animate) / -as (inanimate) | -oss |

**Infinitive:** root + *-ael*

**Example — *mil* (root: to see):**

| | Imperfective | Perfective | Prospective |
|---|---|---|---|
| I see/saw/will see | *milom* | *vemilom* | *aemilom* |
| You | *mileth* | *vemileth* | *aemileth* |
| He/She | *milos* | *vemilos* | *aemilos* |
| It | *milas* | *vemilas* | *aemilas* |
| We | *milomm* | *vemilomm* | *aemilomm* |
| They | *miloss* | *vemiloss* | *aemiloss* |

Infinitive: *milael* — "to see"

**Negation:** prefix *nil-* before the verb: *nilmilos* — "he does not see." With aspect prefixes, *nil-* comes first: *nilve-milos* — "he did not see."

### Adjectives

Adjectives follow the noun they modify and take a shortened suffix agreeing with noun class:
- Class I nouns: adjective ends in *-or*
- Class II nouns: adjective ends in *-ith* or *-ol*
- Class III nouns: adjective ends in *-el*
- Class IV nouns: adjective ends in *-eth*

Examples: *voran vaer-or* (a good person), *homath vaer-el* (a good house), *homa mittol* (a central/middle settlement).

### Word Order

**Formal / written:** SOV — Subject, Object, Verb.
**Colloquial / spoken:** SVO — Subject, Verb, Object.
...
|---|---|---|---|
| *cael* | III | water; to flow (verb root) | Most common word in the language |
| *caelith* | II | river | *cael* + *-ith* (natural feature suffix) |
| *caelon* | II | sea, large body of water | *cael* + *-on* (enlargement suffix) |
| *nill* | III | stone, rock | Geminate; *nil* (single n) = nothing, empty |
| *nilloss* | II | mountain, range | *nill* + *-oss* (mass/collective suffix) |
| *velam* | III | leaf, green growth | |
| *velan* | II | tree | |
| *veloss* | II | forest | *vel* + *-oss* |
| *velm* | II | green place, fertile land | Contracted form; common in place names |
| *ond* | II | broad water, slow river | |
| *orch* | III | earth, mineral ore | |
| *orchan* | II | ground, soil | |
| *orcheth* | IV | mining, digging | |
| *ganel* | III | height, elevation | |
| *gan* | II | high place, hill | Contracted; common in place names |
| *tal* | III | fire; heat | |
| *talan* | II | hearth | *tal* + *-an* (bounded place suffix) |
| *taloss* | III | open fire, blaze | |
| *smael* | III | grey, cold (Northern root) | Does not appear in Standard; borrowed |
| *aezh* | III | wind | |
| *aezhan* | IV | storm | |
| *drel* | III | descent, downward slope | Also directional root (south) |

### Directions and Position

| Mittoli | Meaning | Notes |
|---|---|---|
| *vorn* | north; to turn northward | *vornan* = the north; *vornoss* = northerner |
| *drel* | south; descent | *drelan* = the south; *dreloss* = southerner |
| *nyro* | east; dawn-side | *nyrothan* = the east; *nyross* = eastern folk |
| *sael* | west; sea-side | *saelthan* = the west; *saeloss* = westerner |
| *ganel* | above, high | |
| *milve* | below, beneath | |
| *mitt* | middle, center | Core root; also "balanced, fair" |
| *azh* | inward, enduring | "What stays"; also used for "deep" |

### People and Society

| Mittoli | Class | Meaning | Notes |
|---|---|---|
| *voran* | I | person, human being | Most basic Class I noun |
| *voranoss* | I (pl.) | people, folk | |
| *hom* | III | dwelling, home | Root of many settlement names |
| *homath* | III | house, building | *hom* + *-ath* (constructed thing) |
| *homoss* | II | settlement, cluster of dwellings | |
| *homa* | II | the dwelling-place (named) | Place-name form; as in *Nova Homa* |
| *veth* | II | hold, fortified settlement | Old word; appears as prefix *Veth-* |
| *vethan* | II | walled city | |
| *aelos* | IV | speech, a saying | From *ael* (to speak) |
| *aeloss* | III | language, the body of speech | |
| *nov* | — | new, renewed | Adjective/root; *novan* = newcomer |
| *azhon* | — | old, ancient, enduring | Adjectival form of *azh* |
| *vaer* | — | good, fine, well-made | Most common positive adjective |
| *dross* | — | bad, broken, harmful | |
| *caer* | — | clear, open, known | Also "honest"; from *cael* (flow clearly) |
| *nilor* | I | one who has nothing; an outcast | From *nil* (nothing) + person suffix |

### Verbs

| Root | Infinitive | Meaning | Notes |
|---|---|---|---|
| *mil* | *milael* | to see | Most common perceptual verb |
| *ael* | *aelael* | to speak, to say | The doubled form is considered poetic |
| *cael* | *caelael* | to flow, to run | Water and movement |
| *azh* | *azhael* | to endure, to remain | *veazhael* = to have survived |
| *hom* | *homael* | to dwell, to inhabit | |
| *veth* | *vethael* | to hold, to keep, to defend | |
| *gal* | *galael* | to cross, to ford | |
| *tal* | *talael* | to burn; to be passionate | |
| *nov* | *novael* | to renew, to change | |
| *drel* | *drelael* | to descend, to fall | |
| *mil-veth* | *milvethael* | to watch over, to guard | Compound: see + hold |
| *nil-azh* | *nilazhael* | to abandon, to leave behind | Compound: nothing + endure |

### Numbers

Mittoli uses base-ten counting. Numbers above ten are additive.

| Number | Mittoli | | Number | Mittoli |
|---|---|---|---|---|
| 1 | *el* | | 10 | *velon* |
| 2 | *dae* | | 11 | *velon-el* |
| 3 | *trin* | | 12 | *velon-dae* |
| 4 | *cov* | | 20 | *daeron* (two-tens) |
| 5 | *meth* | | 100 | *methoss* (five-fold twenty? archaic) → *elvelon* (one hundred) |
| 6 | *threl* | | | |
| 7 | *saen* | | | |
| 8 | *noch* | | | |
| 9 | *aevon* | | | |

*Meth* (5) also means "hand" in older registers. *Velon* (10) originally meant "full count."

---

## Place Name Etymologies

With the core vocabulary established, the place names in the lore can be read as Mittoli words:

| Name | Etymology | Literal meaning |
|---|---|---|
| **Azhora** | *azh* (endure) + *-ora* (that which / the one that) | *The enduring place* or *that which remains* |
| **Mittolo** | *mitt* (middle) + *-ol* (place suffix) + *-o* (Class II nominative marker, archaic) | *The middle land* |
| **Caeras** | *cael* (water/flow) + *-ras* (path, archaic) | *The water-road* — original name of the great river |
| **Velm** | *vel* (green/growth) + *-m* (contracted place marker) | *The green place* |
| **Ond** | *on-* (broad) + *-d* (water marker, archaic) | *The broad water* — likely pre-standard |
| **Veth Ossian** | *veth* (hold/settlement) + *oss* (high) + *-ian* (of/pertaining to, archaic genitive) | *Hold of the high ground* |
| **Gala** | *gal* (to cross) + *-a* (place suffix) | *The ford / the crossing* |
| **Nyross** | *nyro* (east) + *-oss* (people/community suffix) | *Eastern folk* — originally a people-name, became a place-name |
| **Zoth** | *zo-* (beyond, outward) + *-th* (threshold marker) | *The threshold / the outpost* — Pyrosi-influenced form |
| **Cocrone** | *coc-* (bend, curve — archaic) + *-rone* (large settlement, grander than *-a*) | *Settlement at the bend* — the river curves sharply here |
| **Alelo** | *al* (beside, near) + *-el* (water, diminutive) + *-o* (place) | *Beside the little water* |
| **Te Nillium** | *te-* (prefix: renewed, rebuilt) + *nill* (stone) + *-ium* (built-of, archaic suffix) | *New stone-built place* — *te-* prefix implies a prior settlement |
| **Ganoss** | *gan* (height) + *-oss* (place-of / community-of) | *Place of the heights* |
| **Talermolis** | *tal* (fire) + *-er* (keeper/agent) + *mol* (upland district) + *-is* (adj. suffix) | *The fire-keeper's upland district* — likely from the fumaroles |
| **Nova Homa** | *nov* (new) + *a* (connective particle) + *hom* (dwelling) + *-a* (place suffix) | *New dwelling-place* — the *a...a* frame is a naming convention for founded cities |
| **Tros** | *tr-* (crossing/bridge prefix) + *-os* (fixed point) | *The crossing-point* |
| **Ganoss** | *gan* (height) + *-oss* | *The heights* |
| **Orched** | *orch* (earth/ore) + *-ed* (adjectival suffix) | *Ore-rich / earthy* — applied to the hills |
| **Autumbus Bay** | *autum* (harvest-season, late turning) + *-bus* (mouth/opening, archaic) | *Harvest-mouth bay* — a bay that sheltered harvest-time ships |
| **Smunders Bay** | Northern: *smael* (grey/cold) + *und-* (flat water) + *-ers* (Northern pl.) | *Grey flat waters* — a Northern compound; Standard would say *Smaelond* |
| **Bay of Lol** | *Lol*: pre-Mittoli, untranslatable | The name precedes any Mittoli word for it. Scholars note the absence with discomfort. |
...
> *Thael voran homath milae?*
> — "Does the person see the house?" (formal)

> *Voran milos homath.*
> — "The person sees the house." (formal SOV)

> *Voran homath milos.*
> — same meaning, colloquial SVO

> *Nilmilos.*
> — "He/she does not see [it]."

### The Name of the Language (as spoken by its speakers)

> *Aelossmitten voranossae Mittoloel.*
> — *Aeloss* (language/speech) + *-mitten* (genitive compound of *mitt*, middle) + *voranossae* (of the people, gen. pl.) + *Mittoloel* (in Mittolo, locative).
> "The speech of the people of the middle land, spoken in Mittolo."
> In practice shortened to *Aelossmitten* or simply *Mitten* in informal reference.

### The First Silence (from oral tradition)

The Mittoli phrase used in the tradition *"the people before us left"* renders as:

> *Voranoss azhonor nilazhael vemiloss.*
> — *Voranoss* (people, nom. pl.) + *azhonor* (ancient/enduring, Class I adj.) + *nilazhael* (abandoned, from *nil-azh-* compound) + *vemiloss* (they [were] seen [to go], perfective).
> Lit: "The ancient people abandoned [this place] and were seen no more."

The phrasing is significant: *nilazhael* ("to un-endure," to stop remaining) is the Mittoli concept for departure. You do not leave — you cease to stay. The distinction matters.

### A Common Saying

> *Cael novos; nill azhoas.*
> — "Water renews; stone endures."
> The inanimate 3rd person *-as* on *azhoas* rather than *-os* marks stone as non-animate. The saying is used to mean: some things change, some things are permanent. Applied to people, places, decisions.
