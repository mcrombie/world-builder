...
category: language
tags: [language, conlang, Pyros, West Pyrosi, East Pyrosi, Taler, registers, volcanic, fire-memory, Ossic script, abugida, Proto-Western, grammar, Tallyss, oral-tradition, pitch-accent, proverbs, written-genres, idiom, diplomacy, letters, court-poetry, commentary, social-ceremony, register-walking, Gala, kěl-taloss, kael-kěl, vaer-vel, pyross-ell]
status: draft
...
### Letters and Diplomatic Correspondence (*Vaer-Vel*)

The formal letter in West Pyrosi is called a *vaer-vel* — "social-return," the correspondence that extends the Social register across distance. The term distinguishes formal letters from private household correspondence (*neth-oss*, "home-marks," typically not written in Ossic at all) and from fixed legal records (*khoth-oss*, boundary stones and their documentary equivalents). A *vaer-vel* travels; it arrives; it is addressed to someone who will read it without the sender present.

A *vaer-vel* follows a structure with named parts.

**The *Kael-Oss* (elevated address)**: The letter opens by naming the recipient in Elevated register. Even if the sender and recipient are of equal standing — or if the sender is superior — the opening addresses the recipient as *kael-ran*. This is not deference; it is the formal acknowledgment that correspondence crosses a distance which is always honored. The intuition is that a letter in transit is a living thing (Class I); it has been in motion; and what has been in motion and arrived is owed the same elevation as an arriving guest at the threshold. The formula: *Kael-vel-milloss [recipient's oss-name]-in* — "The elevated witness has seen [your arrival]." This is technically a fiction — the letter is going toward the recipient, not arriving from them — but Galan scribes accept it without comment. A letter arrives before the reader sees it; the crossing is already complete; you are addressing what has already been received.

**The *Sol-Oss* (familiar record)**: The body of the letter uses Familiar register if the relationship permits it, Social register if it does not. A Galan magistrate writing to a Mittoli trade representative they respect but have never met uses Social throughout; an elder writing to a counterpart they have known for twenty years uses Familiar from the second paragraph onward. The shift is not signaled; a careful reader of Pyrosi correspondence can read the relationship's depth in when — and whether — the register changes.

**The *Lleth-Ell* (latent closing)**: The letter closes with a statement in Latent aspect — something that is already true and that the correspondence has simply named. Common formula: *Lleth-vel-kěl ell-elloss-in* — "The return is latent in the speech-body." The correspondence is not ending; it is waiting in the ground. This is not consolation; it is a description of how Pyrosi correspondence works. A letter sent into a long silence is assumed to be *lleth-oss* — in the permanent condition of not yet expressed — not lost.

Letters between West Pyros and Mittoli powers go through East Pyrosi scribes who work in both scripts and have developed a professional translation register that is not quite either language. The Galan diplomatic community maintains this register because Mittoli recipients find unmediated formal Pyrosi difficult to hold — it does things with register that Mittoli has no grammar to receive. Galan practitioners consider the translation register useful and slightly embarrassing in equal measure.

What travels with formal letters of significance is as important as the text. A *vaer-vel* of substance is accompanied by a named gift calibrated to the relationship: a *kěl-taloss* gift (something produced by the volcanic soil — oil, mineral salt, characteristic stone) for a new correspondent; an item of craft for one already in Social register; and for a Familiar correspondent, something from the household rather than the land. The categories are not explicit rules. They are the accumulated judgment of Galan correspondence culture, and deviation from them is read.

### Elevated-Register Poetry (*Kael-Kěl*)

*Kael-kěl* — elevated-water-speech — is the formal written poetry of West Pyros, composed in Elevated register and addressed to one of three possible recipients: the land, a person of significant standing, or the dead. Where *tallos-ell* is narrative oral literature and *kěl-ell* is the lyric oral form that changes seasonally, *kael-kěl* is composed in Ossic, addressed to something that cannot respond in kind, and designed to outlast its occasion. The subject of a *kael-kěl* is always the most significant addressee available; this distinguishes it from praise offered in social gatherings, which uses Social or Familiar register and does not last. *Kael-kěl* is composed when the elevated address must become permanent.

The conventional form has three named movements.

**The *Lleth-Vel* (the latent arrival)**: The opening establishes what was always true about the subject — what fire was already in the land before the occasion, what the person's *llyr* held before the event being marked. A *kael-kěl* for a returning elder begins with what made the return inevitable; for a fumarole site, with what the ground has always held; for the dead, with what was permanently true of them that the living could not name until it ended. The *Lleth-Vel* uses Latent aspect throughout. It is not praise; it is recognition of what was already real.

**The *Vel-Toss* (the burning arrival)**: The middle movement names the specific occasion — what happened, what burned, what crossed. It shifts to Perfective and Prospective aspects; here the poem names events. For a person of standing, it names their completed crossings; for the dead, names what they have permanently marked; for the land, names what has surfaced and what remains below. This section permits the only sanctioned departure from strict Elevated register in a formal *kael-kěl*: a single line in Familiar register, attributed to someone close to the subject, is considered the mark of a skilled practitioner. The line says: this elevated person was also *sol-* to someone; this fumarole was addressed plainly by a farmer who worked beside it; this deceased was familiar to a household. The brief Familiar line is not a break in the poem's structure — it is the acknowledgment that even the most elevated carry a *neth* at their center.

**The *Pyross-Ell* (the ash-speech)**: The closing movement names what will remain when the occasion passes — what the subject has *pyrossed* into the permanent record. Class II constructions throughout; everything has settled, become fixed. The closing formula conventionally ends with a single Class II noun in the nominative, left without a verb: the last word naming the thing that continues. Common final nouns: *lleth* (the latent ground), *oss* (the permanent mark), *velr* (the resonance), *llos* (the ash that was transformed). A *kael-kěl* ending on *velr* is widely considered the most complete form — what the subject has left is the resonance, still speaking.

The *kael-kěl* tradition is maintained in Gala by the *kěloss-van* — the formal poetic community of the city, which holds the tradition's conventions, acknowledges accomplished practitioners, and composes the official poems for occasions of civic significance. The *kěloss-van* is not a guild; membership is recognized by the community rather than certified. A practitioner whose *kael-kěl* for a major occasion is acknowledged as accomplished has received that recognition from the community, not an institution. A practitioner who composes a formally perfect but emotionally cold *kael-kěl* is recognized as technically competent, and left to that.

The most cited *kael-kěl* in Galan records is the **Llossal-Ell** — the ash-speech composed after the fumarole event in the Talermolis uplands three generations ago, when a sudden release of sulfurous gas killed twenty farmers on the upland plain. The poem was composed by a practitioner named **Tossvan** the following day. It is considered the finest surviving example of the *Vel-Toss* movement because its single Familiar register line — attributed to a farmer working the adjacent field at the moment of the eruption — says only: *Sol-milom kael-rath.* "I saw [familiar] the elevated weight." A farmer reaching for *kael-* because nothing else was sufficient for what had landed on the neighbors. Galan practitioners cite the line whenever arguing whether the brief *sol-* inclusion is a technique or a requirement. The poem ends on *velr*.

### Commentary Literature (*Pyross-Ell*)

The Tallyss texts are not explained publicly. What can be said is said at the fumarole sites, in the planting rites, in the seasonal ceremonies; what is in the Tallyss vocabulary remains there unless a practitioner chooses to bring it out — and practitioners do not bring it out carelessly. The *pyross-ell* commentary tradition exists because sometimes it needs to come out, and the genre that developed around that necessity is among the most contested in Pyrosi literary culture.

A *pyross-ell* is a text that addresses a Tallyss word, phrase, or practice and attempts to explain it to an educated reader who does not hold the full Fire Memory. The explanation is not translation — the tradition explicitly holds that translation is impossible, and a commentary that presents itself as a translation is both wrong and dishonest about what it has done. A commentary addresses what can be said; names the edges of what cannot; and provides enough context for an educated reader to participate intelligently in Tallyss without fully entering it.

The genre's founding text is a commentary on the word *llethvan* by a West Pyrosi practitioner named **Ossvel**, a Galan fire-keeper of four generations ago who produced it because a delegation from the Caeras Valley Academy had misunderstood *llethvan* in a way that was affecting their recommendations for Pyrosi agricultural land use. Ossvel's commentary was written throughout in Social register. Galan practitioners consider this either diplomatic or bitterly ironic depending on whom you ask.

The commentary's most quoted passage addresses whether *llethvan* is permission or condition:

*Vaer-ellom: llethvan-oss nil-vaer-ran. Sol-milleth: llethvan-oss vel-hom-ossoss lleth-es. Vel-kěl pyrant-in vel-vel-gall.*

"I speak [social]: *llethvan* is not something given from above. You see [familiar]: *llethvan* is [the condition of being] already home in the latency. The flowing-return into the living soil is a crossing already completed."

The passage is considered an example of Social register used to deliver a correction that would, in Elevated register, be received as a rebuke. The shift to Familiar in the second sentence — *sol-milleth* — is the pivot: Ossvel moves to the closer register to deliver the central claim plainly, pulling the reader momentarily into the register where obvious things can be said without ceremony. The Caeras Valley Academy's agricultural recommendations changed. Ossvel's commentary is cited in two Academy texts; neither citation acknowledges the register in which the correction was delivered. Scholars outside Pyros read the text as philosophical clarification. Galan readers find this funny and have not explained why.

Conventions of the *pyross-ell* form:
- Opens with the Tallyss word or phrase being addressed, rendered in full Ossic script
- States in the second section what the word is *not* — negative definition first, because the tradition holds that Tallyss vocabulary resists positive definition more readily than it resists being distinguished from what it is not
- Provides a *vel-llyryr* section: an account of a specific observed instance or practice that gives the word's scope of application
- Closes with the *pyross* section — what can be permanently said: a single claim the commentary is prepared to have carved on a boundary stone. This is short. One sentence. Practitioners who write multi-sentence *pyross* sections are considered either brave or overconfident; Galan practice does not distinguish between these

---

## The Feast of Welcome and Social Ceremony

### The Feast of Welcome (*Kěl-Taloss*)

The formal feast in West Pyros is not simply a meal; it is a structured speech event in which the progressive register shifts of the evening enact the social work of the occasion. A formal *kěl-taloss* — water-fire, the feast in which fire is given something to flow through — follows a recognized sequence that every adult Galan knows and that visitors who do not know it find bewildering at first and, upon explanation, consider one of the more transparent social systems they have encountered.

**Opening (*Kael-vel*, the elevated arrival)**: Guests enter to Elevated register. The host addresses each guest as *kael-ran* — the elevated one, the one toward whom elevated speech is directed. This is not ceremony at arm's length; it is correct. Every guest, regardless of their standing elsewhere, is spoken to in *kael-* at the threshold. The logic is that a guest has traveled, has chosen to come, and has arrived; this is sufficient for elevation. A guest who does not know this reads the opening as formality and mistakes it for coldness. It is the opposite.

**First water (*Vaer-kěl*)**: Water is brought before food. The host offers it with the formula: *Vaer-tossom lleth-ellyr* ("I have been burning — I was always going to speak to you") followed by the guest's name. The guest's response — accepting the water — signals willingness to proceed. A guest who must decline for any reason can do so here without dishonor; the *vaer-kěl* is also the last clean exit before the feast commits. Those who have received the water know this, which is why the formula is said before the water is placed, not after.

**The shift to Social (*Vaer-ell*)**: Once water is taken, the host shifts from Elevated to Social register. The guest is no longer elevated as a newly arrived stranger is elevated; they have become a guest under active household care. The meal proceeds in Social register for its first courses. A Mittoli merchant sitting next to a Galan at this stage will notice that the Galan is speaking to the host with what sounds like extraordinary warmth but also formality — slower pace, fuller vowels, rising phrase-ends. They are correct to notice it. They are wrong to think the relationship has cooled. The Social register at this stage is the warmth; the Elevated was the honor. They are different.

**The *Gall-Ell* exchange**: At some point in the meal — determined by the host, never announced — the host makes a remark in Familiar register. This is the invitation. A guest who responds in Familiar has accepted: the relationship has moved from Social to Familiar, and the evening proceeds at that pace. A guest who responds in Social has not accepted yet — for any number of reasons; not all of them are refusals. Some guests are not ready; some occasions call for Social to be maintained because mixed company includes strangers who are not yet *vaer-gall*. The host reads all of this without comment.

**Close (*Kael-vel-llyryr*)**: At the end of the feast, the host returns briefly to Elevated register for the farewell. *Vel-llyryr* — "returned through the body" — is spoken; in the farewell context this means: you have been here; it is recorded. The guest departs back into their life carrying what was spoken. The Elevated register at the close mirrors the Elevated at the arrival; the guest was elevated on entry and is elevated again at departure. What happened between — the register shifts, the meal, whatever familiarity was reached — is now part of what the fire will record.

The *kěl-taloss* is the occasion at which formal *kael-kěl* poetry is sometimes performed. The tradition is that a practitioner from the *kěloss-van* may be present at feasts of significance to compose or recite a *kael-kěl* addressed to the gathering — specifically, a short form in which the occasion itself is addressed in Elevated register as though the feast were itself the *kael-ran*. This is considered the most difficult *kael-kěl* form to execute well, because the audience is present for it and can hear whether the register is performed with genuine prosodic weight or merely claimed. A *kael-kěl* delivered with flat prosody in a living feast is understood immediately and remembered unfavorably. The practitioner is addressing the fire while sitting at the table it has made.

### Register-Walking (*Kael-Sol-Gall*)

*Kael-sol-gall* — elevated-familiar-crossing — is the recognized practice by which a person of elevated social standing moves through ordinary community life using Familiar or Social register, rather than receiving what others would use for them.

West Pyros has a name for this practice because it has a tradition of it. The tradition holds that no elder, magistrate, or *talmarr* can fully hold their obligation to the community without having, at regular intervals, moved through it without the register that marks their standing. The logic is direct: when you are addressed in *kael-*, you cannot receive certain kinds of information. People speak differently to those above them. A community leader who receives only *kael-*-register information about their own community eventually comes to hold a model of it that belongs to the elevated register — a model of what people want the elevated to know, which is not the same as what is.

*Kael-sol-gall* is not deception exactly. A practitioner does not lie about who they are; they simply use Familiar or Social register when they would normally receive *kael-*, and allow others to respond in kind. If their identity is recognized, they acknowledge it and the practice ends for that occasion. What was learned during the *gall* is carried back.

The practice is distinguished from ordinary social mixing by its deliberateness: a *kael-sol-gall* is a recognized departure from standing, not a moment when formality relaxes naturally. An elder who uses Familiar register at a family gathering is not practicing *kael-sol-gall*; the family circle already has its register. The practice applies specifically to moving through parts of the community that would not naturally address you familiarly — the lower markets of Gala, the outlying fields, the settlements along the trade roads that have never seen the magistrate's face.

The famous example in Galan tradition is a magistrate known afterward as **Velkhoss of Gala** — a *gall-ell* name given him after an extended period of *kael-sol-gall* through the lower city. He reported afterward, in a text Galan councils have cited for several generations, that the *sol-*-register understanding of a specific water-rights dispute was entirely different from what had been presented to the council in Elevated register — not false, but shaped by what was appropriate to say upward. The water-rights settlement that followed used his *sol-*-register findings; it held. His original name is not recorded in the tradition; he is remembered by what the practice made him. *Vel-Kael-Sol*: "the one who returned to the elevated through the familiar." Galan practitioners consider it one of the better *gall-ell* names in the civic record because it names the route rather than the destination.

*Kael-sol-gall* is not universally admired. The criticism is that it introduces an asymmetry: the elevated practitioner enters the community knowing who they are; the community does not know who is among them; the knowledge gained is not fairly exchanged. West Pyros speakers who make this argument use the term *sol-rath* — register-debt. The elevated one acquires a *sol-rath* in the familiar community they move through, because that community has spoken freely to someone who was not, in those moments, fully among them.

Galan tradition has not resolved this argument. It has simply continued the practice, and recorded both positions, and noticed that the magistrates who practice *kael-sol-gall* and those who don't tend to make different kinds of mistakes.
