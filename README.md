...
Religion is now one of the setting's major organizing systems. Most Azhoran traditions are plural and practice-based: civic gods, household rites, local powers, trade cults, mystery initiations, sacred geographies, and a shared belief in a unified divine principle behind the gods. The Elodi are the great exception, insisting that this principle is a single sovereign authority above all other powers, which makes them both persecuted minorities and persecutors where their institutions control public space. Minora is the center of the cult of Mithalenna, Lady of the First Division, a river, healing, birth, and restoration cult spreading through the Lizeem trade network.
